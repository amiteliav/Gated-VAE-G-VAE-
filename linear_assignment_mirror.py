"""
 AMIT: NOTE!!
    as you can see in the warnings -
    ...
    but I read online 'scipy.optimize.linear_sum_assignment instead' isn't the right replacement
    so I copy the original code to my project
"""
